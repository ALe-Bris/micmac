...
#define MACRO_INSTANTIATE_GEOM2D_MAPPING(TYPE,TMAP,DIM)\
...
#define MACRO_INSTANTIATE_LINEAR_GEOM2D_MAPPING(TYPE,TMAP,DIM)\
template  TMAP TMAP::StdGlobEstimate(tCRVPts,tCRVPts,TYPE*,tCPVVals);\
MACRO_INSTANTIATE_GEOM2D_MAPPING(TYPE,TMAP,DIM)

#define MACRO_INSTANTIATE_NON_LINEAR_GEOM2D_MAPPING(TYPE,TMAP,DIM)\
MACRO_INSTANTIATE_GEOM2D_MAPPING(TYPE,TMAP,DIM); \
...
MACRO_INSTANTIATE_NON_LINEAR_GEOM2D_MAPPING(TYPE,cRot2D<TYPE>,2);\
template  cRot2D<TYPE> cRot2D<TYPE>::RandomRot(const TYPE & AmplTr);\
MACRO_INSTANTIATE_LINEAR_GEOM2D_MAPPING(TYPE,cSim2D<TYPE>,2);\
MACRO_INSTANTIATE_LINEAR_GEOM2D_MAPPING(TYPE,cHomot2D<TYPE>,2);\
